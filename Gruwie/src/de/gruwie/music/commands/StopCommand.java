...
public class StopCommand extends CommandInfo implements ServerCommand{
	...
	public StopCommand() {
		super(false, true, StopCommand.class.getSimpleName(), ":stop_button:", "Gruwie will do the following things: *Stop playing music, Clearing the music-queue, leaving the voice-channel*\nIf noone except Gruwie is connected to a voice-channel this command will be executed automatically");
	}
