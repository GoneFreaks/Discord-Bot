...
public class ExportGuildPlaylistCommand extends ServerCommand {
	...
	public ExportGuildPlaylistCommand() {
		super(false, true, ExportGuildPlaylistCommand.class, "The playlist name, one word with up to 30 characters", null, "Save queue as Guild-Playlist", "Save the current music-queue as a server-specific playlist with the provided name (no spaces are allowed)\nOnly Admins of the server can use this command");
	}
